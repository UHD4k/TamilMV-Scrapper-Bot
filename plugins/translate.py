...
async def about(client, message):
          ...
          await message.reply_text(text =f"<b>🤖 My Name :- [Google Translator Star Bots](https://t.me/Google_Translator_Star_Bot)\n\n🧑🏻‍💻 Developer :- [Karthik](https://t.me/TG_Karthik)\n\n📝 Language :- Python3\n\n📚 Framework :- Pyrogram\n\n📡 Hosted on :- VPS\n\n🤖 Bot Channel :- [Star Bots Tamil](https://t.me/Star_Bots_Tamil)\n\n🎥 Movie Updates :- [Star Movies Tamil](https://t.me/Star_Moviess_Tamil)</b>",reply_to_message_id = message.id , parse_mode=enums.ParseMode.HTML, reply_markup=InlineKeyboardMarkup(            [                [                    InlineKeyboardButton("🤖 Bot Channel" ,url="https://t.me/Star_Bots_Tamil") ],                 [InlineKeyboardButton("🎥 Movie Updates", url="https://t.me/Star_Moviess_Tamil"),InlineKeyboardButton("👥 Support Group",url = "https://t.me/Star_Bots_Tamil_Support") ]           ]        ) )
